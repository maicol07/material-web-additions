...
Example: `mwc-card` will be split into `md-card`, `md-outlined-card`, etc
...
<mwc-layout-grid>
    <mwc-card outlined>
        <mwc-card-primary-action disabled>
            <mwc-card-media style={{'--mdc-card-media-background-image': 'url("https://lh3.googleusercontent.com/_wVZOGd-J2P8egccQlY_MI6w01npq0bfNY1zVlvWjYqPFFjLP8G0ZNcCEkB572LMGT-GkptT_rVZRgj4jSn7ibRN02pMhCIG4Qjy4A=w1064-v0")'}} />
    ...
    <mwc-card outlined>
        <mwc-card-primary-action onClick={linkTo('Card')}>
            <mwc-card-media style={{'--mdc-card-media-background-image': 'url("https://github.com/material-components/material-components-web/raw/master/packages/mdc-card/images/card-elevated.png")'}} />
            <div className="component-card__header">
                <div className="components-card-header">
                    <div className="demo-card__title components-card-header-title">
                        <span className="components-card-header-title-text">Card <code>mwc-card</code></span>
                        <a target="_blank" href="https://www.npmjs.com/package/@maicol07/mwc-card">
                            <img src="https://img.shields.io/npm/v/@maicol07/mwc-card.svg" alt="Published on NPM"/>
                        </a>
                    </div>
                    <div className="demo-card__subtitle">
        ...
        <a href="https://github.com/material-components/material-web/blob/mwc-card/packages/card" title="Go to original repo (Material web repo - mwc-card branch)" target="_blank" slot="icon">
            <mwc-icon-button icon="source" aria-label="Go to original repo"/>
        </a>
    </mwc-card>
    <mwc-card outlined>
        <mwc-card-primary-action disabled>
            <mwc-card-media style={{'--mdc-card-media-background-image': 'url("https://lh3.googleusercontent.com/nIlSfsCutvqK4ZGO91rq9ktUX90a6t7zQhf7KFH-3RXL7gMcUDrLVFafgDr82PgnbiBuwLn8t1vvVcL66wHp9p5VYocPI-7fYb9w=w1064-v0")'}} />
            <div className="component-card__header">
                <div className="components-card-header">
                    <div className="demo-card__title components-card-header-title">
    ...
    <mwc-card outlined>
        <mwc-card-primary-action disabled>
            <mwc-card-media style={{'--mdc-card-media-background-image': 'url("https://github.com/material-components/material-components-web/raw/master/packages/mdc-data-table/images/data-table-hero.png")'}} />
            <div className="component-card__header">
                <div className="components-card-header">
                    <div className="demo-card__title components-card-header-title">
                        <span className="components-card-header-title-text">Data Table <code>mwc-data-table</code></span>
                    </div>
                    <div className="demo-card__subtitle">
    ...
    <mwc-card outlined>
        <mwc-card-primary-action onClick={linkTo('Layout Grid')}>
            <mwc-card-media style={{'--mdc-card-media-background-image': `url("${LayoutGridImage}")`}} />
            <div className="component-card__header">
                <div className="components-card-header">
                    <div className="demo-card__title components-card-header-title">
                        <span className="components-card-header-title-text">Layout Grid <code>mwc-layout-grid</code></span>
                        <a target="_blank" href="https://www.npmjs.com/package/@maicol07/mwc-layout-grid">
                            <img src="https://img.shields.io/npm/v/@maicol07/mwc-layout-grid.svg" alt="Published on NPM"/>
                        </a>
                    </div>
                    <div className="demo-card__subtitle">
                        <span>
        ...
        <a href="https://github.com/chromakey-io/mwc-layout-grid" title="Go to original repo (Chromakey - mwc-layout-grid)" target="_blank" slot="icon">
            <mwc-icon-button icon="source" aria-label="Go to original repo"/>
        </a>
    </mwc-card>
    <mwc-card outlined>
        <mwc-card-primary-action disabled>
            <mwc-card-media style={{'--mdc-card-media-background-image': 'url("https://lh3.googleusercontent.com/duoMsnozKjVDWvdKT25cpk9hO612I8nws7A3Bv-9NPBV8Kt8XP4ystWxdODf5uP4bDChjbT5M7Jqtbc6PoadSXF4aFmwUd7HU3bWSg=w1064-v0")'}} />
            <div className="component-card__header">
                <div className="components-card-header">
                    <div className="demo-card__title components-card-header-title">
