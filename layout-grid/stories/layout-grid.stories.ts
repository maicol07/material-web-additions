...
type LayoutGridStory = Story<Partial<MdLayoutGrid>>;
...
export const Basic: LayoutGridStory = ({fixedColumnWidth, align}) => html`
...
export const CustomSpanSize: LayoutGridStory = ({fixedColumnWidth, align}) => html`
    <md-layout-grid class="demo-grid" ?fixedColumnWidth="${fixedColumnWidth}" align="${align}">
...
export const Nested: LayoutGridStory = ({fixedColumnWidth, align}) => html`
    <md-layout-grid class="demo-grid" ?fixedColumnWidth="${fixedColumnWidth}" align="${align}">
...
export const GridAlignment: LayoutGridStory = ({fixedColumnWidth, align}) => html`
    <md-layout-grid class="demo-grid demo-grid--alignment" ?fixedColumnWidth="${fixedColumnWidth}" align="${align}">
        <div class="demo-cell"></div>
        <div class="demo-cell"></div>
        <div class="demo-cell"></div>
    </md-layout-grid>
...
export const GridCellsAlignment: LayoutGridStory = ({fixedColumnWidth, align}) => html`
    <md-layout-grid class="demo-grid demo-grid--cell-alignment" ?fixedColumnWidth="${fixedColumnWidth}"
                    align="${align}">
...
export const GridCellsOrder: LayoutGridStory = ({fixedColumnWidth, align}) => html`
    <md-layout-grid class="demo-grid" ?fixedColumnWidth="${fixedColumnWidth}" align="${align}">
