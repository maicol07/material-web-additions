...
| `<mwa-card>`           | [![Published on npm](https://img.shields.io/npm/v/@maicol07/mwa-card.svg)](https://www.npmjs.com/package/@maicol07/mwa-card)               | [AuthX](https://github.com/AuthX) ([Repo](https://github.com/AuthX/material-components-web-components/blob/develop/packages/card)) |
...
| `<mwa-layout-grid>`    | [![Published on npm](https://img.shields.io/npm/v/@maicol07/mwa-layout-grid.svg)](https://www.npmjs.com/package/@maicol07/mwa-layout-grid) | [Chromakey](https://github.com/chromakey-io) ([Repo](https://github.com/chromakey-io/mwa-layout-grid))                             |
...
```sh
git clone git@github.com:@maicol07/mwa-layout-grid.git material-web-additions
