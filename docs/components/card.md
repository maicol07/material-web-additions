...
--- | --- | --- | ---
`getRenderClasses` | _None_ | `ClassInfo` | 
`getPrimaryActionRenderClasses` | _None_ | `ClassInfo` | 
`stopActionPropagation` | `action` | `void` | 
`getRenderActionsClasses` | _None_ | `{ 'mdc-card__actions': boolean; }` | 
