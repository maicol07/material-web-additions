...
Install a component from
    ```sh
npm install @amaicol07/material-web-additions
```
...
<html lang="en">
  ...
  <body>
    ...
    <script type="module">
      ...
      import '@amaicol07/material-web-additions/layout-grid/layout-grid.js';
...
transforms them to a * path * (for example with `md-layout-grid` to`./node_modules/@amaicol07/material-web-additions/layout-grid/layout-grid.js`).
