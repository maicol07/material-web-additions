...
`rowCallback` |  | `(e: Event) => void` | `function { ... }` |
`headerRowCallback` |  | `() => void` | `function { ... }` |
`filterColumnCallback` |  | `(e: Event) => void` | `function { ... }` |
`sortColumnCallback` |  | `(e: Event) => void` | `function { ... }` |
...
--- | --- | --- | ---
`onHeaderCellSlotChange` | _None_ | `void` |
...
`onCheckboxClicked` |  | `(e: Event) => void` | `function { ... }` |
...
Method | Parameters | Returns | Description
--- | --- | --- | ---
`renderCheckbox` | _None_ | `string \| TemplateResult<1>` |
`onSlotChanged` | _None_ | `void` |
...
`sortButton` |  | `IconButton` | `undefined` |
...
--- | --- | --- | ---
`renderCheckbox` | _None_ | `string \| TemplateResult<1>` |
`renderFilterTextField` | _None_ | `TemplateResult<1> \| unique symbol` |
`renderSlot` | _None_ | `TemplateResult<1>` |
`renderSortButton` | _None_ | `TemplateResult<1>` |
`onCheckboxClicked` | `e` | `void` |
`onCheckboxSlotChanged` | _None_ | `void` |
`onFilterTextFieldInput` | `e` | `void` |
`onFilterTextFieldKeyDown` | `e` | `void` |
`onSortButtonClicked` | `e` | `void` |
