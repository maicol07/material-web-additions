                    ...
                    <div className="component-card__header">
                        <div className="components-card-header">
                            <div className="demo-card__title components-card-header-title">
                                <span className="components-card-header-title-text">{component.name}
                                    <code>md-{slug}</code></span>
                            </div>
                            <div className="demo-card__subtitle">
                                ...
                                {!component.released && (
                                    <>
                                        <br/><br/>
                                        <small className="components-card-status">Status: <a target="_blank"
