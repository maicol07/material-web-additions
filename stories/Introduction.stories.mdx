...
Install a component from
    ```sh
npm install @maicol07/material-web-additions
```
...
transforms them to a * path * (for example with `md-layout-grid` to`./node_modules/@maicol07/material-web-additions/layout-grid/layout-grid.js`).
